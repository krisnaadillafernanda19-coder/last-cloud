...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (count($errors) === 0) {
        ...
        set_flash('success', "Produk \"$title\" berhasil ditambahkan.");
        redirect('dashboard.php');
    }
}
...
<head>
    ...
    <style>
        ...
        .game-option:checked + .game-label {
            border-color:var(--primary);background:rgba(255,107,53,0.1);color:var(--primary);
        }
...
<div class="form-wrap">
    <div style="margin-bottom:28px;">
        ...
        <p style="font-size:14px;color:var(--text-muted);margin-top:6px;">Isi semua field di bawah untuk menambah produk baru.</p>
    </div>
    ...
    <form method="post">
            ...
            <div class="game-selector">
                <?php foreach ($games as $game): ?>
                    <input type="radio" name="game_name" id="game_<?= e(str_replace(' ','_',$game)) ?>"
                           ...
                           <?= ($game_name === $game || ($game_name === '' && $game === 'Mobile Legends')) ? 'checked' : '' ?>>
        ...
        <div class="field" style="margin-bottom:16px;">
            ...
            <input id="title" name="title" type="text" required
                   placeholder="Contoh: 86 Diamonds / Akun Sultan"
                   value="<?= e($title) ?>">
        </div>
        ...
        <div class="field" style="margin-bottom:16px;">
            ...
            <textarea id="desc" name="description" rows="3"
                      placeholder="Deskripsi singkat produk..."><?= e($description) ?></textarea>
        </div>
            ...
            <div class="field">
                ...
                <div class="price-input">
                    ...
                    <input id="price" name="price" type="number" required min="1"
                           placeholder="15000" value="<?= e($price) ?>">
                </div>
            </div>
            <div class="field">
